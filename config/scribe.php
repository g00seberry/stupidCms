...
return [
    ...
    'title' => sprintf('%s API', config('app.name', 'stupidCms')),
    ...
    'base_url' => rtrim(config('app.url'), '/') . '/api/v1',
    ...
    'static' => [
        ...
        'output_path' => base_path('docs/_generated/api-docs'),
    ],
    ...
    'auth' => [
        ...
        'extra_info' => 'Получите JWT через <code>POST /api/v1/auth/login</code> или используйте refresh endpoint.',
    ],
    ...
    // Note: does not work for `external` docs types
    'last_updated' => 'Last updated: {date:Y-m-d H:i}',
