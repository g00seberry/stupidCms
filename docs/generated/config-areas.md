...
### Meta
- **Keys:** `disks`, `default`, `collections`, `videos`, `documents`, `kinds`, `image`, `video`, `max_upload_mb`, `allowed_mimes`, `variants`, `thumbnail`, `max`, `medium`, `signed_ttl`, `public_signed_ttl`, `path_strategy`, `driver`, `quality`, `glide_driver`, `metadata`, `ffprobe`, `enabled`, `binary`
