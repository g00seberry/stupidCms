...
### Meta
- **Keys:** `disks`, `default`, `kinds`, `image`, `video`, `max_upload_mb`, `allowed_mimes`, `variants`, `thumbnail`, `max`, `medium`, `large`, `signed_ttl`, `public_signed_ttl`, `path_strategy`, `driver`, `quality`, `glide_driver`, `metadata`, `getid3`, `enabled`, `ffprobe`, `binary`, `mediainfo`, `exiftool`, `cache_ttl`, `exif`, `auto_rotate`, `strip`, `whitelist`, `preserve_color_profile`
- **Sections:** `disks`, `kinds`, `allowed_mimes`, `variants`, `thumbnail`, `medium`, `large`, `image`, `metadata`, `getid3`, `ffprobe`, `mediainfo`, `exiftool`, `exif`
